...
модели:  
`FC` — первый переход. `LC` — последний переход. `LSC` — последний
значимый переход. `LYDC` — последний переход из Яндекс Директа. `FCCD` –
первый переход кросс-девайс. `LSCCD` – последний значимый переход
кросс-девайс. `LYDCCD` – последний переход из Яндекс Директа
кросс-девайс. `AUTO` – автоматическая атрибуция.  
